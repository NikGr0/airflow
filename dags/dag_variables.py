...
task1 = BashOperator(
    task_id='task1',
    bash_command='python3 /airflow/scripts/dag_variables/main_script.py --variable ' + v_value,
    dag=dag)

task2 = BashOperator(
    task_id='task2',
    bash_command='python3 /airflow/scripts/dag_variables/main_script.py --variable ' + v_password,
    dag=dag)
